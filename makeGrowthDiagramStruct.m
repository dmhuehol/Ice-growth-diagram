...
if crystalLog==1
    ...
    hd.Plates.vaporBounds = iceSupersatToVapor(hd.Plates.supersatBounds,hd.Plates.TempBounds);
    ...
    hd.ColumnLike.vaporBounds = iceSupersatToVapor(hd.ColumnLike.supersatBounds,hd.ColumnLike.TempBounds);
    ...
    hd.SectorPlates.vaporBounds = iceSupersatToVapor(hd.SectorPlates.supersatBounds,hd.SectorPlates.TempBounds);
    ...
    hd.Dendrites.vaporBounds = iceSupersatToVapor(hd.Dendrites.supersatBounds,hd.Dendrites.TempBounds);
    ...
    hd.PolycrystalsP.vaporBounds = iceSupersatToVapor(hd.PolycrystalsP.supersatBounds,hd.PolycrystalsP.TempBounds);
    ...
    hd.PolycrystalsC.vaporBounds = iceSupersatToVapor(hd.PolycrystalsC.supersatBounds,hd.PolycrystalsC.TempBounds);
    ...
    hd.Mixed.waterBounds = iceSupersatToRH(hd.Mixed.supersatBounds.*100,hd.Mixed.TempBounds);
    hd.Mixed.vaporBounds = iceSupersatToVapor(hd.Mixed.supersatBounds,hd.Mixed.TempBounds);
...
if otherLog==1
    ...
    hd.subsaturated.vaporBounds = iceSupersatToVapor(hd.subsaturated.supersatBounds,hd.subsaturated.TempBounds);
    ...
    hd.warm.vaporBounds = iceSupersatToVapor(hd.warm.supersatBounds,hd.warm.TempBounds);
